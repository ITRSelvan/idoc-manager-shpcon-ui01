sap.ui.define(
  [
    ...
    "com/idocmanagershpconui01/model/formatter",
  ...
  /**
         ...
         *@param {com.idocmanagershpconui01.model.formatter} formatter formatter
  ...
  function (
    ...
    "use strict";
    return BaseController.extend("com.idocmanagershpconui01.controller.Idoc_Items", {
      formatter: formatter,
      /* =========================================================== */
      /* lifecycle methods                                           */
      /* =========================================================== */
      ...
      iGetInput: function (mObjectId) {
        ...
        const sGetIdocItemsUrl = "/sap/opu/odata/sap/ZITR_IDM_SHPCON_SRV/DetailsSet?&$expand=nav_item&$filter=IDoc_Number eq '" + mObjectId + "'";
        //'/sap/opu/odata/sap/ZITR_IDM_SHPCON_SRV/IDoc_detailsSet?IDoc_Number eq "'+mObjectId+'"&$expand=Nav_matnr_details';
