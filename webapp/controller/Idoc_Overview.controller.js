sap.ui.define(
    [
      ...
      // eslint-disable-next-line @sap/ui5-jsdocs/check-jsdoc-param-type
      "sap/m/MessageBox",
      "com/idocmanagershpconui01/lib/RestService",
      // eslint-disable-next-line @sap/ui5-jsdocs/check-jsdoc-param-type
      "sap/ui/model/Filter",
      // eslint-disable-next-line @sap/ui5-jsdocs/check-jsdoc-param-type
    ...
    /**
     *
     * @param {com.idocmanagershpconui01.controller.BaseController} BaseController Base Controller
     ...
     * @param {com.idocmanagershpconui01.lib.RestService} Rest Rest Service
     ...
     * @returns {com.idocmanagershpconui01.controller.BaseController} Controller
     */
    function (
      BaseController,
      JSONModel,
      ...
      return BaseController.extend(
        "com.idocmanagershpconui01.controller.Idoc_Overview",
        {
          onInit: function () {
          ...
          GetIDocOverview: function () {
            ...
            const sGetIdocStatusUrl =
              '/sap/opu/odata/sap/ZITR_IDM_SHPCON_SRV/Total_IdocsSet?Idoc_Status=" "';
            ...
            oWhenCallReadIsDone.then(
              ...
              (rejectedData) => {
                MessageBox.error(rejectedData.responseJSON.error.message.value);
                this.getView().setBusy(false);
              }
            );
          },
          ...
          onUpdateFinished: function (oEvent) {
            ...
            ///sap/opu/odata/sap/ZITR_IDM_SHPCON_SRV/Total_idocsSet/$count?&$filter=Idoc_status eq 'Error'
          ...
          onWorkflowButtonClick: function () {
            ...
            if (!this.byId("processDialog")) {
              ...
              Fragment.load({
                ...
                name: "com.idocmanagershpconui01.view.fragment.Workflow",
          ...
          showWorkflowResultDialog: function () {
            ...
            if (!this.byId("workflowRsltDialog")) {
              ...
              Fragment.load({
                id: that.getView().getId(),
                name: "com.idocmanagershpconui01.view.fragment.WorkflowResult",
                controller: oFragmentController,
              }).then(function (oDialog) {
                // connect dialog to the root view of this component (models, lifecycle)
                that.getView().addDependent(oDialog);
          ...
          processCreation: function (mProcessPara, mIdocIndex) {
            ...
            $.ajax({
              ...
              const sPostProcessUrl =
                "/sap/opu/odata/sap/ZITR_IDM_SHPCON_SRV/Process_IDOCSSet";
              const oWhenCallReadIsDone = Rest.ajaxCall(
                "POST",
                sPostProcessUrl,
                mProcessPara,
          ...
          showProcessResultDialog: function () {
            ...
            if (!this.byId("processRsltDialog")) {
              ...
              Fragment.load({
                id: that.getView().getId(),
                name: "com.idocmanagershpconui01.view.fragment.ProcessResult",
                controller: oFragmentController,
              }).then(function (oDialog) {
                // connect dialog to the root view of this component (models, lifecycle)
                that.getView().addDependent(oDialog);
