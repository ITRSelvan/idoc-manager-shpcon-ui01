sap.ui.define(
  ...
  function (
    ...
    return BaseController.extend(
      "com.idocmanagershpconui01.controller.Idoc_MassEdit",
      {
        /**
        ...
        GetServerData: function () {
          ...
          const sGetIdocStatusUrl =
            '/sap/opu/odata/sap/ZITR_IDM_SHPCON_SRV/Idoc_massSet?IDoc_Number=" "';
        ...
        massUpload: function (mMass_Upload_Para, mIdocIndex) {
          ...
          $.ajax({
            ...
            const sPostMassUploadUrl =
              "/sap/opu/odata/sap/ZITR_IDM_SHPCON_SRV/mass_uploadSet";
        ...
        showWorkflowResultDialog: function () {
          ...
          if (!this.byId("masseditRsltDialog")) {
            ...
            Fragment.load({
              ...
              name: "com.idocmanagershpconui01.view.fragment.MassEditResult",
