		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Idoc Manager SHPCON",
									"targetURL": "#comidocmanagershpconui01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comidocmanagershpconui01-display": {
								"semanticObject": "comidocmanagershpconui01",
								"action": "display",
								"description": "A Basic BAS Fiori application.",
								"title": "Idoc Manager SHPCON",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.idocmanagershpconui01",
									"url": sap.ui.require.toUrl("com/idocmanagershpconui01")
								}
							}
						}
					}
